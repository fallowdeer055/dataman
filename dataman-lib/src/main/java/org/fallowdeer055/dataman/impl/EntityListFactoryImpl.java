...
public class EntityListFactoryImpl implements EntityListFactory {

	private static EntityListFactoryImpl instance = null;

	public static synchronized EntityListFactoryImpl getInstance() {
		if (instance == null) {
			instance = new EntityListFactoryImpl();
		}
		return instance;
	}

	private EntityListFactoryImpl() {
	}
